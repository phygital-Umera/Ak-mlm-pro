...
const CustomerFundTransfer = () => {
  ...
  // Handle fund transfer submission - UPDATED TO CUSTOMER ENDPOINT
  const handleFundTransfer = async (data: any) => {
    ...
    try {
      // Prepare payload for customer/transfer API
      ...
      // CHANGED: Using customer transfer endpoint instead of admin
      const response = await api.post('/transfer/customer', transferPayload);
                ...
                <div className="mt-4">
                  ...
                  {customerData && (
                    <div className="text-gray-600 mt-2 text-sm">
                      <p>Email: {userEmail}</p>
                      <p>Balance: ₹{customerData.totalEpin || 0}</p>
                    </div>
                  )}
