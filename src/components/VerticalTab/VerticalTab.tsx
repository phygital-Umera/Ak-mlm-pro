...
//   tabData: any; // define the type of tabData
//   setJsxElement: (element: any) => void; // define the type of setJsxElement
// }

// const VerticalTab: React.FC<VerticalTabProps> = ({tabData, setJsxElement}) => {
